Public Class clsGoodsReceipt
    ...
    Private Sub AddControl(ByVal aForm As SAPbouiCOM.Form)
        aForm.Freeze(True)
        oApplication.Utilities.AddControls(aForm, "stIns", "22", SAPbouiCOM.BoFormItemTypes.it_STATIC, "DOWN", , , , "Include Transportation", 140)
        oApplication.Utilities.AddControls(aForm, "cmbIns", "21", SAPbouiCOM.BoFormItemTypes.it_COMBO_BOX, "DOWN", , )

        oCombobox = aForm.Items.Item("cmbIns").Specific
        oCombobox.ValidValues.Add("Y", "Yes")
        oCombobox.ValidValues.Add("N", "No")
        oCombobox.DataBind.SetBound(True, "OIGN", "U_Z_Trans")
        ...
        oCombobox.DataBind.SetBound(True, "OIGN", "U_Z_TrnsCode")
        ...
        oEditText.DataBind.SetBound(True, "OIGN", "U_Z_Amount")
        AddChooseFromList(aForm)

        oApplication.Utilities.AddControls(aForm, "stCardCode", "20", SAPbouiCOM.BoFormItemTypes.it_STATIC, "DOWN", , , , "Transporter  Code", )
        oApplication.Utilities.AddControls(aForm, "edCardCode", "3", SAPbouiCOM.BoFormItemTypes.it_EDIT, "DOWN", , )
        oItems = aForm.Items.Item("stCardCode")
        oItems.LinkTo = "edCardCode"
        oEditText = aForm.Items.Item("edCardCode").Specific
        oEditText.DataBind.SetBound(True, "OIGN", "U_Z_CardCode")
    ...
    Private Function createDocument(ByVal aDocEntry As Integer) As Boolean
        ...
        oStockTransfer = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oInventoryGenEntry)
        If oStockTransfer.GetByKey(aDocEntry) Then
            If oStockTransfer.UserFields.Fields.Item("U_Z_Trans").Value = "Y" And oStockTransfer.UserFields.Fields.Item("U_Z_TrnsCode").Value <> "" And oStockTransfer.UserFields.Fields.Item("U_Z_Amount").Value > 0 Then
                ...
                oDoc.CardCode = oStockTransfer.UserFields.Fields.Item("U_Z_CardCode").Value
                otest = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                ...
                oDoc.Comments = "Created based on Goods Receipt Number : " & oStockTransfer.DocNum & " and transportation Type : " & otest.Fields.Item("U_Z_Name").Value
    ...
    Public Sub FormDataEvent(ByRef BusinessObjectInfo As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean)
        ...
        Try
            If BusinessObjectInfo.BeforeAction = False And BusinessObjectInfo.ActionSuccess = True And (BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_ADD Or BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE) Then
                ...
                If oForm.TypeEx = frm_GoodsReceipt Then
